...
DEFAULT_IN = "tmp/manual/inputs/buildings_master/buildings_master_secondary.csv"
DEFAULT_OUT = "tmp/manual/outputs/buildings_master/buildings_master_secondary_normalized.csv"
